        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-2 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    <a href="{{ route('postscategorized') }}" class="nav-item nav-link active">Home</a>
                  <!--  <a href="{{ route('listcategories') }}" class="nav-item nav-link">Category</a> !--->
                    <a href="{{ route('indexposts') }}" class="nav-item nav-link">posts</a>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="row">
                    <div class="col-4 mb-3">
                        <a href=""><img class="w-100" src="{{asset('Users/img/news-110x110-1.jpg')}}" alt=""></a>
                    </div>
                    <div class="col-4 mb-3">
                        <a href=""><img class="w-100" src="{{asset('Users/img/news-110x110-2.jpg')}}" alt=""></a>
                    </div>
                    <div class="col-4 mb-3">
                        <a href=""><img class="w-100" src="{{asset('Users/img/news-110x110-3.jpg')}}" alt=""></a>
                    </div>
                    <div class="col-4 mb-3">
                        <a href=""><img class="w-100" src="{{asset('Users/img/news-110x110-4.jpg')}}" alt=""></a>
                    </div>
                    <div class="col-4 mb-3">
                        <a href=""><img class="w-100" src="{{asset('Users/img/news-110x110-5.jpg')}}" alt=""></a>
                    </div>
                    <div class="col-4 mb-3">
                        <a href=""><img class="w-100" src="{{asset('Users/img/news-110x110-1.jpg')}}" alt=""></a>
                    </div>
